        ...
        <>
            ...
            >
                <div className="group w-28 md:w-32 md:h-14 h-12 font-bold p-1 relative">
                    ...
                    <div className="w-11/12 h-4/5 bg-blue-800 group-hover:bg-gradient-to-r from-blue-700 to-bgBlue duration-500 absolute left-0 top-0 text-xs md:text-sm text-white flex flex-row items-center justify-center">
