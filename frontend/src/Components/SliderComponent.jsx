                                                ...
                                                ([key, value], index) => (
                                                    <Link
                                                        ...
                                                        className={
                                                            (key ===
                                                                "linkedin" &&
                                                                "bx bxl-linkedin-square text-blue-700 text-3xl cursor-pointer") ||
                                                            (key ===
                                                                "twitter" &&
                                                                "bx bxl-twitter text-blue-700 text-3xl cursor-pointer")
                                                        }
                                                    ></Link>
                                                )
                                            )}
