    ...
    return (
        <div className='max-lg:w-full '>
            <li className={`group flex flex-col items-center relative max-lg:items-start max-lg:px-0 max-lg:w-full`}>
                ...
                {about && <div className={`cursor-pointer bg-white text-[#010035]  font-light z-50 py-8 text-md absolute px-8 w-[500%] left-[50%] translate-x-[-50%] top-[55px] group-hover:block max-lg:top-[0%] max-lg:left-[0%] max-lg:translate-x-[0%] max-lg:translate-y-[0%] max-lg:py-4 max-lg:static`} >
