...
const Administration = () => {
    ...
    const breadcrumbs = [
        ...
        <Link key={2} className='text-blue-500' href="/administration/admin" onClick={handleClick} >
            Administration
        </Link>
      ];
    ...
    <div className='w-full h-auto lg:min-h-[calc(100vh-150.39px)] font-sans'>
        <div className='p-2 px-4 bg-white'>
            ...
            <div className='w-full flex items-center justify-center relative'>
                ...
                <h2 className='text-blue-700 text-2xl lg:text-4xl font-semibold z-0 absolute'>Administration</h2>
            </div>
