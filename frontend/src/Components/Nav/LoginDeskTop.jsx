...
const LoginDeskTop = () => {
    ...
    return (
        <div className=' relative max-lg:hidden '>
            ...
            {login &&  <div className={`cursor-pointer bg-white text-[#010035]  font-light z-50 py-8 text-md absolute px-8 w-[155%] left-[45%] translate-x-[-60%] top-[63px] group-hover:block max-lg:top-[0%] max-lg:left-[0%] max-lg:translate-x-[0%] max-lg:translate-y-[0%] max-lg:py-4 max-lg:static`} >
